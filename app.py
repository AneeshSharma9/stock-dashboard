...
def serve_layout():
    ...
    return html.Div(children=[
        ...
        html.Div(children='Ticker: ',style={'display': 'inline-block', 'padding-left': '41vw', 'padding-right': '1vw'}),
        dcc.Input(id='input2', value='', type='text',persistence=True,style={'display': 'inline-block','width': '4vw'}),
        
        dcc.Graph(id='graph1',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
        dcc.Graph(id='graph2',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
        ...
        dcc.Graph(id='graph3',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
        dcc.Graph(id='graph4',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
        ...
        dcc.Graph(id='graph5',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
        dcc.Graph(id='graph6',style={'display': 'inline-block', 'width': '49vw', 'height' : '50vh'}),
    ])
